...
Обратите внимание, если не задан начальный (`from`, `0%`) или конечный (`to`, `100%`) кадр, браузер установит для них расчетные значения анимируемых свойств такими, какими они были бы если бы не была применена анимация.
