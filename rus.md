...
Однако, такие функции можно создавать самому. Специальный аргумент `animation-timing-function:cubic-bezier(arg, arg, arg, arg)` принимает четыре параметра и строит на их основе функцию анимации. Потренироваться в создании своих функций анимации и посмотреть как они работают можно на [http://cubic-bezier.com/][11] или [https://matthewlein.com/ceaser/][10].
